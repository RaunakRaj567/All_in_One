...
# Determine base directory for Routees - iNTEGRATED
BASE_DIR = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", ".."))

# Paths to user's pre-trained ML models & historical market datasets
MODEL_CONFIG = {
    "Wheat": {
        "model_path": os.path.join(BASE_DIR, "Demand forecasting", "wheat", "wheat_demand_forecasting_model.joblib"),
        "data_path": os.path.join(BASE_DIR, "Demand forecasting", "wheat", "wheat_market_1000.xls"),
        "crop_str": "Wheat",
        "scale_factor": 8.0
    },
    "Onion": {
        "model_path": os.path.join(BASE_DIR, "Demand forecasting", "Onion", "linear_regression_demand_model_onion.joblib"),
        "data_path": os.path.join(BASE_DIR, "Demand forecasting", "Onion", "onionn_market_1000.xls"),
        "crop_str": "Onion",
        "scale_factor": 8.0
    },
    "Rice": {
        "model_path": os.path.join(BASE_DIR, "Demand forecasting", "riceee", "rice_demand_forecasting_model.joblib"),
        "data_path": os.path.join(BASE_DIR, "Demand forecasting", "riceee", "rice_market_1000.xls"),
        "crop_str": "Rice",
        "scale_factor": 8.0
    },
    "Maize": {
        "model_path": os.path.join(BASE_DIR, "Demand forecasting", "maize", "maize_demand_forecasting_model.joblib"),
        "data_path": os.path.join(BASE_DIR, "Demand forecasting", "maize", "maize_market_1000.csv"),
        "crop_str": "Maize",
        "scale_factor": 8.0
    }
}
...
def get_market_forecasts(crop: str, date: str) -> Tuple[Dict[str, float], Dict[str, float]]:
    ...
    try:
        ...
        if month == 10 and dt.day >= 10:
            price_multiplier += 0.06
        elif month == 11 and dt.day <= 15:
            price_multiplier += 0.04
