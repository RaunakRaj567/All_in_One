...
FALLBACK_DIR = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "..", "Crop suggester"))
...
MODEL_PATH = resolve_model_path('crop_model.pkl')
ENCODER_PATH = resolve_model_path('label_encoder.pkl')
