...
def solve_profit_allocation(
    ...
    for loc in LOCATIONS:
        ...
        # 1. Market Demand Bound Calculation:
        # For maximum_profit mode: cap allocation at full market demand so higher net profit cities get prioritized.
        # For balanced_distribution mode: distribute supply proportionally across markets if supply <= total demand.
        if coverage_mode == "balanced_distribution" and total_raw_demand > 0 and available_quantity_kg <= total_raw_demand:
