...
def run_routing_service(
    ...
    return {
        ...
        "routing_summary": {
            ...
            "max_duration_minutes": cvrp_result.get("max_duration_minutes", cvrp_result["total_duration_minutes"]),
            "delivery_window_minutes": cvrp_result.get("max_duration_minutes", cvrp_result["total_duration_minutes"]),
